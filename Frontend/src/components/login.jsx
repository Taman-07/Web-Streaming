...
export default function Login() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 sm:p-6 bg-[radial-gradient(ellipse_at_top,#9a8e97_0%,#7d727c_45%,#6a6068_100%)]">
      <div className="login-fade-up w-full max-w-[920px] min-h-[540px] bg-white rounded-[28px] shadow-[0_25px_60px_-20px_rgba(0,0,0,0.35)] flex overflow-hidden">
        {/* LEFT — Form */}
        <div className="w-full md:w-1/2 px-8 sm:px-12 py-10 flex flex-col justify-center">
          <div className="text-center mb-9">
            <h1 className="text-[2rem] sm:text-[2.15rem] font-bold text-[#1a1a1a] tracking-tight leading-none">
              Hello Again!
            </h1>
            <p className="mt-3 text-[0.9rem] text-[#9ca3af] font-medium">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <input
              ...
              className="w-full bg-[#eeeeef] text-[#1a1a1a] placeholder:text-[#a8adb5] rounded-xl px-4 py-3.5 outline-none border border-transparent focus:bg-white focus:border-[#926c72]/40 focus:ring-2 focus:ring-[#926c72]/12 transition"
              required
            />
            ...
            <div>
              <div className="relative">
                <input
                  ...
                  className="w-full bg-[#eeeeef] text-[#1a1a1a] placeholder:text-[#a8adb5] rounded-xl px-4 py-3.5 pr-12 outline-none border border-transparent focus:bg-white focus:border-[#926c72]/40 focus:ring-2 focus:ring-[#926c72]/12 transition"
                  required
                />
                <button
                  type="button"
              ...
              <div className="flex justify-end mt-2.5">
                <button
                  type="button"
                  className="text-[0.8rem] text-[#9ca3af] hover:text-[#926c72] transition"
                >
                  Recovery Password
                </button>
              </div>
            ...
            <button
              type="submit"
              className="w-full mt-3 bg-[#926c72] hover:bg-[#7f5c62] active:scale-[0.99] transition-all duration-200 rounded-xl py-3.5 text-white font-semibold tracking-wide shadow-[0_12px_24px_-6px_rgba(146,108,114,0.7)]"
            >
              Sign In
            </button>
          </form>
          ...
          <p className="login-fade-up-delay text-center text-sm text-[#9ca3af] mt-8">
        ...
        <div className="hidden md:block w-1/2 p-4 pl-2">
          <div className="login-slide-in relative h-full min-h-[500px] rounded-[1.75rem] overflow-hidden">
            <img
              key={current.image}
              src={current.image}
              alt=""
